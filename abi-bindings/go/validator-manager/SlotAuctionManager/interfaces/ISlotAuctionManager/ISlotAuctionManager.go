...
func (_ISlotAuctionManager *ISlotAuctionManagerTransactor) InitiateValidatorRegistration(opts *bind.TransactOpts, nodeID []byte) (*types.Transaction, error) {
	return _ISlotAuctionManager.contract.Transact(opts, "initiateValidatorRegistration", nodeID)
}

// InitiateValidatorRegistration is a paid mutator transaction binding the contract method 0xfc94c5ce.
//
// Solidity: function initiateValidatorRegistration(bytes nodeID) returns(bytes32)
func (_ISlotAuctionManager *ISlotAuctionManagerSession) InitiateValidatorRegistration(nodeID []byte) (*types.Transaction, error) {
	return _ISlotAuctionManager.Contract.InitiateValidatorRegistration(&_ISlotAuctionManager.TransactOpts, nodeID)
}

// InitiateValidatorRegistration is a paid mutator transaction binding the contract method 0xfc94c5ce.
//
// Solidity: function initiateValidatorRegistration(bytes nodeID) returns(bytes32)
func (_ISlotAuctionManager *ISlotAuctionManagerTransactorSession) InitiateValidatorRegistration(nodeID []byte) (*types.Transaction, error) {
	return _ISlotAuctionManager.Contract.InitiateValidatorRegistration(&_ISlotAuctionManager.TransactOpts, nodeID)
}
...
// ISlotAuctionManagerAuctionVoucherCreatedIterator is returned from FilterAuctionVoucherCreated and is used to iterate over the raw logs and unpacked data for AuctionVoucherCreated events raised by the ISlotAuctionManager contract.
type ISlotAuctionManagerAuctionVoucherCreatedIterator struct {
	Event *ISlotAuctionManagerAuctionVoucherCreated // Event containing the contract specifics and raw log
...
func (it *ISlotAuctionManagerAuctionVoucherCreatedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ISlotAuctionManagerAuctionVoucherCreated)
...
func (it *ISlotAuctionManagerAuctionVoucherCreatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ISlotAuctionManagerAuctionVoucherCreatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ISlotAuctionManagerAuctionVoucherCreated represents a AuctionVoucherCreated event raised by the ISlotAuctionManager contract.
type ISlotAuctionManagerAuctionVoucherCreated struct {
	NodeID           common.Hash
...
func (_ISlotAuctionManager *ISlotAuctionManagerFilterer) FilterAuctionVoucherCreated(opts *bind.FilterOpts, nodeID [][]byte, ownerAddress []common.Address) (*ISlotAuctionManagerAuctionVoucherCreatedIterator, error) {
	...
	logs, sub, err := _ISlotAuctionManager.contract.FilterLogs(opts, "AuctionVoucherCreated", nodeIDRule, ownerAddressRule)
	if err != nil {
		return nil, err
	}
	return &ISlotAuctionManagerAuctionVoucherCreatedIterator{contract: _ISlotAuctionManager.contract, event: "AuctionVoucherCreated", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event AuctionVoucherCreated(bytes indexed nodeID, address indexed ownerAddress, uint256 validatorEndTime, uint64 weight)
func (_ISlotAuctionManager *ISlotAuctionManagerFilterer) WatchAuctionVoucherCreated(opts *bind.WatchOpts, sink chan<- *ISlotAuctionManagerAuctionVoucherCreated, nodeID [][]byte, ownerAddress []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ISlotAuctionManager.contract.WatchLogs(opts, "AuctionVoucherCreated", nodeIDRule, ownerAddressRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(ISlotAuctionManagerAuctionVoucherCreated)
				if err := _ISlotAuctionManager.contract.UnpackLog(event, "AuctionVoucherCreated", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event AuctionVoucherCreated(bytes indexed nodeID, address indexed ownerAddress, uint256 validatorEndTime, uint64 weight)
func (_ISlotAuctionManager *ISlotAuctionManagerFilterer) ParseAuctionVoucherCreated(log types.Log) (*ISlotAuctionManagerAuctionVoucherCreated, error) {
	event := new(ISlotAuctionManagerAuctionVoucherCreated)
	if err := _ISlotAuctionManager.contract.UnpackLog(event, "AuctionVoucherCreated", log); err != nil {
		return nil, err
	}
