...
WrappedNativeToken MockERC20SendAndCallReceiver MockNativeSendAndCallReceiver ExampleERC20Decimals IStakingManager ACP99Manager ValidatorManager PoAManager ISlotAuctionManager 
NativeTokenSlotAuctionManager ERC20TokenSlotAuctionManager"
